...
{
    public partial class MainFormCasher : Form
    {
        public MainFormCasher()
        {
            InitializeComponent();
            loadGrossProfit();
        ...
        private void btncash_Click(object sender, EventArgs e)
        {
            ...
            openChildForm(new Cash(this)); // ghi chu
        }
        ...
        #region method
        // create a function any form to the panelChild on the MainFormCasher
